...
<script crossorigin="anonymous" type="module" src="https://github.githubassets.com/assets/notifications-global-26855372e0da920b.js" defer="defer"></script>
  ...
  <meta name="fetch-nonce" content="v2:3060edd9-bd98-822b-00d4-d06143973d6d">

    
  <meta name="current-catalog-service-hash" content="f3abb0cc802f3d7b95fc8762b94bdcb13bf39634c40c357301c4aa1d67a256fb">


  <meta name="request-id" content="75B7:2FA8C2:E14097:1003566:69BBF5E4" data-turbo-transient="true" /><meta name="html-safe-nonce" content="084eb822f6369dbbf10c039722521a0f4c6e1639b17846daaa1aba0e88797e12" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="b32c8bb42e31b3f286c083f748a5560d8e86683532a8dd1cbd5e1166307cfa17" data-turbo-transient="true" />


    <meta name="hovercard-subject-tag" content="repository:1047075207" data-turbo-transient>


  <meta name="github-keyboard-shortcuts" content="copilot" data-turbo-transient="true" />
  

  <meta name="selected-link" value="/Shruberrie/rsa-aes-steganography-secure-data/raw/refs/heads/main/stegclasses/src/src/stegclasses/imagesteg.py" data-turbo-transient>
  <link rel="assets" href="https://github.githubassets.com/">

    <meta name="google-site-verification" content="Apib7-x98H0j5cPqHWwSMm6dNU4GmODRoqxLiDzdx9I">

<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="92168647" /><meta name="octolytics-actor-login" content="Shruberrie" /><meta name="octolytics-actor-hash" content="6d6d22111c623c64f4c0430a094627cc971c7179e3087fa75d5b1904089a1121" />
...
<meta name="octolytics-page-type" content="marketing" />
    ...
    <meta name="user-login" content="Shruberrie">
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/Shruberrie/rsa-aes-steganography-secure-data/raw/refs/heads/main/stegclasses/src/src/stegclasses/imagesteg.py" />
  ...
  <meta property="twitter:image:height" content="1200">
      ...
      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/92168647/ws?session=eyJ2IjoiVjMiLCJ1Ijo5MjE2ODY0NywicyI6MjAxMzg3NTI3NiwiYyI6MjQ0OTI3NDQwNywidCI6MTc3MzkyNTg2Mn0=--bc3eb0af4ce446ec6a5b081ad95b093b184c902c23e6c449a8ab983e634bb98e" data-refresh-url="/_alive" data-session-id="c85a3be7bd3118c022d6a8daed75274c9f744f0880414065dfe0185c19fb83de">
      <link rel="shared-web-socket-src" href="/assets-cdn/worker/socket-worker-312129489ba60057.js">

      <link rel="service-worker-src" href="/assets-cdn/worker/service-worker-41293e3ebb471ba2.js?current_user=Shruberrie&amp;errors_url=https%3A%2F%2Fapi.github.com%2F_private%2Fbrowser%2Ferrors&amp;release=09c3549d440687a1ad316cff62aed8c303de13f3&amp;actor_id=92168647&amp;is_staff=false&amp;analytics_collector_url=https%3A%2F%2Fcollector.github.com%2Fgithub%2Fcollect">
  ...
  <meta name="is_logged_out_page" content="true">
      ...
      <link rel="canonical" href="https://github.com/Shruberrie/rsa-aes-steganography-secure-data/raw/refs/heads/main/stegclasses/src/src/stegclasses/imagesteg.py" data-turbo-transient>
  ...
  <meta name="release" content="09c3549d440687a1ad316cff62aed8c303de13f3">
...
<qbsearch-input class="search-input" data-scope="owner:Shruberrie" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="09oqG2ryth823mSisBUIxgATHwCcM0NaPKLTkpypet6wDInWsihYTKvQyyZ4xU_5xvh34wGvmBZqbHl6uvWKWA" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="" data-current-org="" data-current-owner="" data-logged-in="true" data-copilot-chat-enabled="false" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-b2faa860-83bf-4427-87d2-47ae2202b4d0" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-b2faa860-83bf-4427-87d2-47ae2202b4d0" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="8JlCn8Nqo_JseYzEsA6kIFViv-FebVumbe6K9-Uw-ro_OAZpLkhgKMNKrDCVPsDkBmhcw0IT8yF7EqTq2d2PZg" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="LNJ2C5z76HI6Kmuh2Vpqyd_7eEhKf3QsbqSzj30aAJ_MkNe0GetSVlKfZmmVN_6sCpDVsvvlNmR3AeJT2udAAQ" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="6z67r2b_taaZ3VJ7zXQjoAaoAQ4UXMNnxCcJatfzvhT25GhVtbE0k52b7FsjCU03DrBc1quF22GoSoNUOiaOvg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input>  <input type="hidden" value="5-4Qsu3UHfj0yFQ-uuoHCFJrJUcZrTnPRYV48omdrZlHItHZD5sxJ8p5YevIzDcpThCuvALC-3IEfBB8nS0rKw" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
    ...
    <button id="icon-button-2a909d3b-69fe-43ea-b42b-6908dae333d7" aria-labelledby="tooltip-1deb3a70-23a1-4faf-8da0-dacceda0fca4" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-1deb3a70-23a1-4faf-8da0-dacceda0fca4" for="icon-button-2a909d3b-69fe-43ea-b42b-6908dae333d7" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  ...
  <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6OTIxNjg2NDciLCJ0IjoxNzczOTI1ODYyfQ==--8945cf3a1d59147c1bf992a661bea3c53e2151077bac975cf828f50fdd47be51" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<template id="snippet-clipboard-copy-button-unpositioned">
  <div class="zeroclipboard-container">
    ...
    <style>
      ...
      .user-mention[href$="/Shruberrie"]:before,
      .user-mention[href$="/Shruberrie"]:after {
        content: '';
